...
| **Effective BL31** | `bin/rk35/rk3568_bl31_v1.45.elf` (rkbin) — required because vendor 5.15 kernel calls Rockchip-vendor SIP SMCs upstream TF-A does not implement | `BR2_PACKAGE_ROCKCHIP_RKBIN_BL31_FILENAME` |
